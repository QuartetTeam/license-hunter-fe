    ...
    return (
        <div id="account-manage" className="account-manage">
            <div className="account-manage-title">
                {accountManageVisible ?
                    <ArrowDown className="account-manage-title__icon"
                               onClick={onVisibleAccountManageClick}/> :
                    <ArrowUp className="account-manage-title__icon"
                             onClick={onVisibleAccountManageClick}/>}
                ...
                <div className="account-manage-box">
                    ...
                    <div className="delete-account">
                        <div className="delete-account__text">
                            <div className="delete-account__description1">데이터와 계정을 삭제하세요
                            </div>
                            <div className="delete-account__description2">귀하의 데이터와 귀하의 계정과
